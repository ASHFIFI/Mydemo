...
public class AudioFxActivity extends Activity
{
    ...
    public void onCreate(Bundle icicle)
    {
        ...
        mMediaPlayer = MediaPlayer.create(this, R.raw.qhc);
        Log.d(TAG, "MediaPlayer audio session ID: " + mMediaPlayer.getAudioSessionId());

        if(ContextCompat.checkSelfPermission(AudioFxActivity.this, Manifest.permission.RECORD_AUDIO)== PackageManager.PERMISSION_GRANTED){
            ...
            ActivityCompat.requestPermissions(AudioFxActivity.this,new String[]{Manifest.permission.RECORD_AUDIO},9);
        }
    ...
    public void onRequestPermissionsResult(int RequestCode,String[] Permissions,int[] Grantresult){
        if(RequestCode == 9){
            if(Grantresult[0]==PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(AudioFxActivity.this,"没有权限",Toast.LENGTH_SHORT).show();
            }
        }
